      ...
      <div className="mt-16 grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="glass noise flex h-full flex-col gap-6 rounded-3xl p-8">
            ...
            <div className="space-y-5">
                ...
                <AnimatePresence mode="wait" initial={false}>
                  {copied ? (
                    ...
                    <motion.span
                      ...
                      animate={{ opacity: 1, scale: 1 }}
                      exit={{ opacity: 0, scale: 0.6 }}
                      className="text-ink-soft group-hover:text-ink"
                    >
              ...
              <a
                ...
                className="focus-ring group flex w-full items-center gap-3 rounded-2xl border border-border/60 bg-canvas/50 p-4 transition-colors hover:border-accent/40"
              >
                <span className="grid h-10 w-10 place-items-center rounded-xl bg-muted/70 text-accent">
            ...
            <div className="mt-auto space-y-3">
              ...
              <div className="flex gap-2">
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="GitHub"
                  className="focus-ring grid h-10 w-10 place-items-center rounded-full border border-border bg-canvas/60 text-ink-soft transition-colors hover:text-ink"
                >
        ...
        <Reveal delay={0.1}>
          <form
            ...
            className="glass noise flex flex-col gap-5 rounded-3xl p-8"
          >
            ...
            <AnimatePresence>
              {status === "error" && (
                <motion.div
                  ...
                  className="flex items-start gap-2 rounded-xl border border-red-400/40 bg-red-500/10 p-3 text-sm text-red-300"
                >
